...
class ToDeliverOrdersPage extends StatefulWidget {
  const ToDeliverOrdersPage({super.key});

  static const String routeName = 'to_deliver_orders_page';

  @override
  State<ToDeliverOrdersPage> createState() => _ToDeliverOrdersPageState();
}

class _ToDeliverOrdersPageState extends State<ToDeliverOrdersPage> {
  ...
  Future<void> _loadOrders() async {
    ...
    try {
      ...
      // Load orders with status 2 (ToDeliver)
      final orders = await OrderApiService.getUserOrders(currentUser.id, status: 2);
